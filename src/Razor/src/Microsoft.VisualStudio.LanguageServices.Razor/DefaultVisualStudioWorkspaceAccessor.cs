...
namespace Microsoft.VisualStudio.LanguageServices.Razor
{
    ...
    internal class DefaultVisualStudioWorkspaceAccessor : VisualStudioWorkspaceAccessor
    {
        ...
        public override bool TryGetWorkspace(ITextBuffer textBuffer, out Workspace workspace)
        {
            ...
            //
            // 1. Look for a workspace associated with the top level buffer. This usually occurrs in Liveshare
            //    scenarios where the top level Razor buffer is added to the remote workspace on the guest.
            ...
            if (TryGetWorkspaceFromRazorBuffer(textBuffer, out workspace))
            {
                return true;
            }
