    ...
    internal class WorkspaceProjectSnapshotChangeTrigger : ProjectSnapshotChangeTrigger
    {
                ...
                case WorkspaceChangeKind.ProjectAdded:
                    {
                        ...
                        {
                            _workspaceStateGenerator.UpdateWorkspaceState(project, projectSnapshot);
                        }
                        break;
                    }
                ...
                case WorkspaceChangeKind.ProjectRemoved:
                    {
                        ...
                        if (TryGetProjectSnapshot(project?.FilePath, out var projectSnapshot))
                        {
                            _workspaceStateGenerator.UpdateWorkspaceState(workspaceProject: null, projectSnapshot);
                        }
        ...
        private void ProjectManager_Changed(object sender, ProjectChangeEventArgs args)
        {
            if (args.Kind == ProjectChangeKind.ProjectAdded)
            {
                ...
                {
                    _workspaceStateGenerator.UpdateWorkspaceState(associatedWorkspaceProject, args.Newer);
                }
            }
        }
